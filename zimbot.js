...
// ⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈
//▮🎀 𝒜𝐿𝐸𝒳𝒜 🎀 2022 ®️ALL RIGHTS RESERVED
...
const timuu = moment.tz('Asia/Calcutta').format('HH:mm:ss')
             ...
             break
                ...
                //if (isLimit(m.sender, isPremium, isCreator, limitCount, limit)) return m.reply(mess.endLimit)
                 ...
                 for (let i of anu) {
                     ...
                     teks += `⬡ *NAME :* ${metadata.subject}\n⬡ *OWNER :* @${metadata.owner.split('@')[0]}\n⬡ *ID :* ${metadata.id}\n⬡ *CREATED :* ${moment(metadata.creation * 1000).tz('Asia/Calcutta').format('DD/MM/YYYY HH:mm:ss')}\n⬡ *MEMBER :* ${metadata.participants.length}\n\n━━━━━━━━━━━━━━━━━━━━━━━━\n\n`
                 }
                 ZimBotInc.sendTextWithMentions(m.chat, teks, m)
             }
             break
...
if (isBan) throw mess.ban
        ...
        ZimBotInc.sendMessage(m.chat, { image: buf, jpegThumbnail:buf, caption: `🎀 𝒜𝐿𝐸𝒳𝒜 🎀` }, { quoted: m }).catch((err) => m.reply('*Sorry Failed In Writing*')) 
        }
        break
case 'magernulis2': {            
if (isBan) throw mess.ban
...
┃ *✧ᴛɪᴍᴇ:* *${moment.tz('Asia/Calcutta').format('HH:mm:ss')}*
┃ 
┃      ↣𝐘𝐨𝐮𝐭𝐮𝐛𝐞↢ 
...
urlButton: {
displayText: 'GITHUB',
url: 'https://github.com/hansaka01t/zimbot-v3'
}
}, {
quickReplyButton: {
displayText: 'SPEED',
...
case 'toxic': {
            ...
            hey = fs.readFileSync('./media/alexa.mp4')
